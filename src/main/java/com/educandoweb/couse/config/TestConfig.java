...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//fazendo as associações dos objetos produtos e categorias. atenção que nesse momento o salvamente está ocorrendo no paradigma orientado a objeto, ainda não é no banco de dados
		...
		//Salvando novamente os produtos, mas agora com as associações com as categorias
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
		...
		Payment pay1 = new Payment(null, Instant.parse("2019-06-20T21:53:07Z"), o1); //para salver um objeto que é dependente de outro não é chamado o repositorio 
		o1.setPayment(pay1);
